export const executado = {
  ...
  projetos: [
    ...
    '<span class="usuario">educaRH</span>',
    'Um sistema de marcação de pontos, com possibilidade de marcar automaticamente ou manual.',
    'Possui gestão de relatórios e usuários, foi realizado com flutter e firebase para o cliente',
    'Helpschool, de Minas Gerais..',
    '<span class="destaque"><a href="https://educarh-ace62.web.app/" target="_blank">Confira aqui.</a></span>',
