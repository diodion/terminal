const linkedin = "https://www.linkedin.com/in/diegorgomes/";
const github = "https://github.com/diodion";

export const executado = {
  ajuda: [
    'Comandos',
    '----------------',
    '<span class="destaque">social</span>               Por enquanto meu linkedin e github :O',
    '<span class="destaque">whois</span>                Um pouco sobre mim. ',
    '<span class="destaque">projetos</span>             Meus principais projetos, confira o resto no github!',
  ...
  social: [
    'Sociais',
    '----------------',
    '<span class="destaque">Linkedin</span>                <a href="' + linkedin + '" target="_blank">Clica aqui!</a>',
    '<span class="destaque">Github</span>                  <a href="' + github + '" target="_blank">E que tal aqui?</a>',
  ]
};
